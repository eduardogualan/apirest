...
return [
    ...
    'grant_types' => [
        // para acceder con permisos desd maquina a maquina ejmplo aplicaciones moviles entre otros
        'client_credentials' => [
            'class' => '\League\OAuth2\Server\Grant\ClientCredentialsGrant',
            'access_token_ttl' => 3600
        ],
        //necesita de loguear o iniicar sesion para generar un token de acceso
        'password' => [
            'class' => '\League\OAuth2\Server\Grant\PasswordGrant',
            'callback' => 'sw\Http\Controllers\OAuth2@AutorizacionPassword',
            'access_token_ttl' => 3600
        ]
    ],
    /*
